  ...
  return (
    <Container>
      ...
      >
        ...
        <Link
          color="text"
          css={{ fontSize: "$lg", fontWeight: "$medium", marginLeft: "20px" }}
          href="#"
        >
          Home
        </Link>
      ...
      >
        <Text h1 css={{ textGradient: "180deg, $blue600 -20%, $blue800 100%" }}>
          Discord Music Bot
        </Text>
        <Text h3 css={{ color: "$gray800" }}>
        ...
        >
          ...
          <Button
            ...
            flat
            onClick={() =>
              window.open("https://github.com/SudhanPlayz/Discord-MusicBot")
            }
            style={{
              marginTop: "1rem",
              marginLeft: "20px",
        ...
        >
          ...
          >
            ...
            <Text css={{ color: "$gray800" }}>
              Use your spotify playlist, youtube videos, youtube playlists and
              much more using this bot
            </Text>
          </Card>
          <Card
            isHoverable
          ...
          >
            ...
            <Text css={{ color: "$gray800" }}>
              Control your song looping song or queue, play or pause your song
              easily, or stop the bot completely.
            </Text>
          </Card>
        </Container>
      </Container>
      ...
      >
        ...
        <Button shadow size={"md"} css={{ marginTop: "5em" }}>
          Start Now
        </Button>
      </Container>
    </Container>
